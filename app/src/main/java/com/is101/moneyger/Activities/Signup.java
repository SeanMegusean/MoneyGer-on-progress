...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signup); // Use "R.layout.activity_signup"
        ...
        findViewById(R.id.SgnupBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pin.length() < 4 || pin.length() > 4 || verifyPin.length() < 4 || verifyPin.length() > 4) {
                    Toast.makeText(Signup.this, "PIN must be 4 digits", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (isInserted) {
                    ...
                    // Navigate to Registration activity (replace if needed)
                    Intent intent = new Intent(Signup.this, Registration.class);
                    startActivity(intent);
